...
public class EditAnalogsTableState : BaseAnalogsTableState, IRuntimeParamsContainer<Component>
{
    ...
    public override async Task Add(TaskCompletionSource tcs, AnalogsTable analogsTable) {
        ...
        WindowServiceHelper.Register<EntryWindow, AnalogsTableWindow>(window);
        
        ResolveRelated();
        var form = _serviceProvider.GetRequiredService<AnalogsForm>();
        await form.ChangeState(form.GetState<AddAnalogsFormState>(), form);
    ...
    public override async Task Edit(TaskCompletionSource tcs, AnalogsTable analogsTable) {
        ...
        var form = _serviceProvider.GetRequiredService<AnalogsForm>();
        await form.ChangeState(form.GetState<EditAnalogFormState>(), form);
