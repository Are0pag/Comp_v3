...
public class ActionDeleteItem : BaseAction
{
    ...
    public ActionDeleteItem(IDataGridCommandScheduler scheduler, ModuleContext context, CommandFactory commandFactory, Cell cell) : base(scheduler, context, commandFactory) {
        _context = context;
        _cell = cell;
    }
